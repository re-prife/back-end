...
INSERT INTO USER_TB (user_id, user_email, user_image_name, user_name, user_nickname, user_password)
VALUES (6, 'freemily@gmail.com', '6.png', '프리밀리', '아이티쇼', '$2a$10$YtRPNN74FuaabDZ6XH6xpuF/X3.tpQbHRaLb02XYhtMmT1swYyPne');

INSERT INTO USER_TB
VALUES (7, 'family@gmail.com', '7.png', 'family', '가족 공유 서비스', '$2a$10$YtRPNN74FuaabDZ6XH6xpuF/X3.tpQbHRaLb02XYhtMmT1swYyPne', 1);
