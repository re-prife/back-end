...
INSERT INTO GROUP_TB
VALUES (2, 'mon0512 ', '민지네2', '취준생 민지와 직딩 친구들과 함께 진행하는 프로젝트.22.^_^');

INSERT INTO USER_TB
VALUES (1, 'm04j00@gmail.com', '1.png', 'Min J', '취준생', 'doremisolsol', 1);
INSERT INTO USER_TB
VALUES (2, 'akwls@gmail.com', '2.png', '마진', '테크타카 1', 'doremisolsol', 2);
INSERT INTO USER_TB
...
INSERT INTO INGREDIENT_TB
VALUES (3, NOW(), NOW(), 'VEGGIE', '5', '2024-07-02', '2.PNG', '고구마 구워먹기', '왕고구마', NOW(), 'FRIDGE', 2);
...
INSERT INTO QUEST_TB
VALUES (3, NOW(), NOW(), 1, TRUE, '오늘 저녁은 치킨이었으면...', '치킨 사서 올 사람', 1, 3);
INSERT INTO QUEST_TB
VALUES (4, NOW(), NOW(), -1, FALSE, '집에 콜라가 없어...', '콜라 사서 올 사람', 1, 4);
INSERT INTO QUEST_TB
VALUES (5, NOW(), NOW(), 1, TRUE, '오늘 저녁은 치킨이었으면...', '치킨 사서 올 사람', 1, 5);
INSERT INTO QUEST_TB
VALUES (6, NOW(), NOW(), 1, TRUE, '집에 콜라가 없어...', '콜라 사서 올 사람', 1, 2);
