...
public class GroupService {
     ...
     * @author: m04j00
     * */
    public GroupIdResponse createGroup(CreateGroupRequest request, long userId, BindingResult bindingResult) {
        ...
        return new GroupIdResponse(group.getGroupId());
    }
     ...
     * @author: m04j00
     * */
    public GroupIdResponse joinGroup(JoinGroupRequest request, long userId, BindingResult bindingResult) {
        formValidate(bindingResult);
        validationUser(userId);
