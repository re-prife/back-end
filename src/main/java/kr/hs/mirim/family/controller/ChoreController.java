...
public class ChoreController {
    ...
    @GetMapping("/one-day")
    public List<ChoreListResponse> choreListOneDay(@ApiParam(value = "집안일을 조회할 그룹의 ID") @PathVariable long groupId,
    ...
    @GetMapping
    public List<ChoreListResponse> choreListMonth(@ApiParam(value = "집안일을 생성할 그룹의 ID") @PathVariable long groupId,
    ...
    public ChoreCertifyReactionResponse choreCertifyReaction(@ApiParam(value = "집안일이 속한 그룹의 ID") @PathVariable long groupId,
                                                             @ApiParam(value = "집안일 상태를 변경할 집안일의 ID") @PathVariable long choreId) {
        return choreService.choreCertifyReaction(groupId, choreId);
    }
